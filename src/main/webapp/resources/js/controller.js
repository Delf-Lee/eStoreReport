...
cartApp.controller("cartCtrl", function($scope, $http) {
	...
	$scope.addToCart = function(productId) {
		...
		$http.put('/eStore/rest/cart/add/' + productId).then(function successCallback() {
	...
	$scope.editToItemQuantity = function(productID, quantity) {
		$scope.setCsrfToken();
		$http.put('/eStore/rest/cart/edit/' + productID + "/" + quantity).then(function successCallback() {
			$scope.refreshCart();
